...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 31 Bulan Mei 2023 pada 16.07
...
INSERT INTO `culinary_detail_facility` (`id`, `id_facility`, `id`) VALUES
('2', '2', 'CU2'),
('7', '2', 'CU4'),
('8', '1', 'CU5'),
('9', '2', 'CU5');
...
('1', '1', 'Bakaua', '2023-04-22', '2023-04-22', 'Kegiatan adat berupa permainan, tari, masak, dan makan bersama untuk warga sekitar', 0, '08388213556', 0x00000000010300000001000000050000000be1d09c6926594031ddf0d21850e9bf0be1b08e6a265940c389a08c1b51e9bf0be1f0d768265940040496061352e9bf0be11005672659401e848ccecc50e9bf0be1d09c6926594031ddf0d21850e9bf),
('E1', '1', 'Bersepedas', '2022-03-31', '2022-03-31', 'Bersepeda ria', 0, '081274876376', 0x00000000010300000001000000050000000be1d09c6926594031ddf0d21850e9bf0be1b08e6a265940c389a08c1b51e9bf0be1f0d768265940040496061352e9bf0be11005672659401e848ccecc50e9bf0be1d09c6926594031ddf0d21850e9bf);
...
--
-- Struktur dari tabel `homestay_detail_facility`
--
...
--
-- Struktur dari tabel `homestay_facility`
--
...
--
-- Struktur dari tabel `homestay_gallery`
--
...
INSERT INTO `souvenir_detail_facility` (`id`, `id_facility`, `id`) VALUES
('1', '1', 'SP1'),
('2', '2', 'SP1');
...
--
-- Dumping data untuk tabel `tourism_detail_facility`
--

INSERT INTO `tourism_detail_facility` (`id`, `id_facility`, `id`) VALUES
('1', '1', 'TO1'),
('4', 'ber1', 'TO1'),
('2', '2', 'TO3'),
('3', 'ber1', 'TO4');
...
ALTER TABLE `culinary_detail_facility`
  ...
  ADD KEY `culinary_facility_culinary_detail_facility_fk` (`id_facility`) USING BTREE,
  ADD KEY `culinary_culinary_detail_facility_fk` (`id`) USING BTREE;
...
--
-- Indeks untuk tabel `homestay_detail_facility`
--
ALTER TABLE `homestay_detail_facility`
  ADD PRIMARY KEY (`id`,`id_facility`),
  ADD KEY `facility_detail_facility_culinary_fk` (`id_facility`) USING BTREE,
  ADD KEY `cullinary_place_detail_facility_culinary_fk` (`id`) USING BTREE;

--
-- Indeks untuk tabel `homestay_facility`
--
ALTER TABLE `homestay_facility`
  ADD PRIMARY KEY (`id_facility`);

--
-- Indeks untuk tabel `homestay_gallery`
--
...
ALTER TABLE `souvenir_detail_facility`
  ADD PRIMARY KEY (`id`,`id_facility`),
  ADD KEY `souvenir_place_souvenir_detail_facility_fk` (`id`) USING BTREE,
  ADD KEY `souvenir_facility_souvenir_detail_facility_fk` (`id_facility`) USING BTREE;
...
ALTER TABLE `tourism_detail_facility`
  ADD PRIMARY KEY (`id`,`id_facility`),
  ADD KEY `tourism_object_tourism_detail_facility_fk` (`id`) USING BTREE,
  ADD KEY `tourism_facility_tourism_detail_facility_fk` (`id_facility`) USING BTREE;
...
ALTER TABLE `worship_detail_facility`
  ADD PRIMARY KEY (`id`,`id_facility`),
  ADD KEY `worship_facility_worship_detail_facility_fk` (`id_facility`) USING BTREE,
  ADD KEY `worship_place_worship_detail_facility_fk1` (`id`) USING BTREE;
...
ALTER TABLE `worship_gallery`
  ADD PRIMARY KEY (`id_gallery`),
  ADD KEY `worship_place_worship_gallery_fk` (`id`) USING BTREE;
...
--
-- Ketidakleluasaan untuk tabel `homestay_detail_facility`
--
ALTER TABLE `homestay_detail_facility`
  ADD CONSTRAINT `cullinary_place_detail_facility_culinary_fk` FOREIGN KEY (`id`) REFERENCES `homestay` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `facility_detail_facility_culinary_fk` FOREIGN KEY (`id_facility`) REFERENCES `homestay_facility` (`id_facility`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Ketidakleluasaan untuk tabel `homestay_gallery`
--
ALTER TABLE `homestay_gallery`
  ADD CONSTRAINT `cullinary_place_gallery_cullinary_fk` FOREIGN KEY (`id`) REFERENCES `homestay` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
ALTER TABLE `tourism_object`
  ADD CONSTRAINT `tourism_object_ibfk_1` FOREIGN KEY (`id_category`) REFERENCES `tourism_category` (`id_category`) ON DELETE NO ACTION ON UPDATE NO ACTION;
