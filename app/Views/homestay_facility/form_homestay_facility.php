                ...
                <div class="card-header">
                    <div class="row align-items-center">
                        ...
                        <div class="row content">
                            <h3><small><?= $content; ?> Homestay Facility</small></h3>
                        </div>
                        <form action="<?= base_url($action) ?>" method="post">
                            ...
                            ?>
                                ...
                                <div class="d-flex p-2 bd-highlight">
                                    <div class="form-group">
                                        <a class="btn btn-sm btn-danger" href="<?= base_url('homestay_facility') ?>">Cancel</a>
                            ...
                            ?>
                                ...
                                <input id="id_facility" class="form-control" type="text" name="id_facility" style="display:none;" value="">
