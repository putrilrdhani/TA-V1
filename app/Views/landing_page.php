            ...
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <h1 class="display-5 mb-4">
                        ...
                        Desa Wisata <span class="text-primary">Payo</span>
                    </h1>
                    <p class="mb-4">
                        Payo merupakan sebuah kawasan pedesaan dengan ketinggian lebih kurang 800 mdpl. Dan di dukung barbagai SDA, kuliner khas, budaya, dan kesenian masyarakat. Destinasi wisata payo memiliki daya tarik wisata yaitu Batu Patah Payo, Bunga Krisan, Kopi Payo, Payo Nature dan Puncak Bidadari, yang terletak di Kelurahan Tanah Garam, Kota Solok. Sejak tahun 2018, Pemerintah Kota Solok melakukan pengembangan kawasan payo sebagai objek agro wisata.
                    </p>
                    <h5 class="mb-3">
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-9 col-md-6">
                    ...
                    <p class="mb-2">
                        <i class="fa fa-map-marker-alt me-3"></i>Kalurahan Tanah Garam, Kota Solok, Sumatera Barat
                    </p>
                    <p class="mb-2">
                        <i class="fa fa-phone-alt me-3"></i>082388313556
                    </p>
                    <p class="mb-2">
                        <i class="fa fa-envelope me-3"></i>kampungwisatapayo@gmail.com
                    </p>
                    <div class="d-flex pt-2">
                        <a class="btn btn-outline-light btn-social" href="https://www.instagram.com/kampung_wisata_payo/"><i class="fab fa-instagram"></i></a>
                        <a class="btn btn-outline-light btn-social" href="https://www.facebook.com/Kawispa%20solok"><i class="fab fa-facebook-f"></i></a>
                    </div>
                </div>
