...
<section class="section">
    <div class="row">
        ...
        <div style="height:400px;overflow-y:scroll;" class="col-md-4">
            ...
            <div class="row">
                <div class="col-sm-12">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><input onchange="facilityMap()" type="checkbox" value="F-<?php echo $facility[$i]->id_facility; ?>"> &nbsp &nbsp <?php echo $facility[$i]->name; ?></td>
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                <td><input disabled onchange="facilityMap()" id="worship" type="checkbox" value="O-worship"> &nbsp &nbsp Worship</td>
                            </tr>
                            <tr>
                                <td><input disabled onchange="facilityMap()" id="souvenir" type="checkbox" value="O-souvenir"> &nbsp &nbsp Souvenir</td>
                            </tr>
                            <tr>
                                <td><input disabled onchange="facilityMap()" id="event" type="checkbox" value="O-event"> &nbsp &nbsp Event</td>
                            </tr>
                            <tr>
                                <td><input disabled onchange="facilityMap()" id="culinary" type="checkbox" value="O-culinary"> &nbsp &nbsp Culinary</td>
                            </tr>
                            <tr>
                                <td><input disabled onchange="facilityMap()" id="homestay" type="checkbox" value="O-homestay"> &nbsp &nbsp Homestay</td>
                            </tr>
                    ...
                    <br />
                    <br />
                    <input disabled onchange="facilityMap()" type="range" class="form-range" id="radiusRange" value="0" min="0" max="20000">
            ...
            <div style="background-color: white;" id="panelRender">
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#search-box").keyup(function() {
                $.ajax({
                    type: "GET",
                    url: "search_name_only_tourism/" + $(this).val(),
        ...
        function fillResult(keyword) {
            ...
            $.ajax({
                type: "GET",
                url: "search_name_tourism/" + keyword,
                // data: 'keyword=' + $(this).val(),
                beforeSend: function() {
                    // $("#search-box").css("background", "#FFF url(LoaderIcon.gif) no-repeat 165px");
                },
