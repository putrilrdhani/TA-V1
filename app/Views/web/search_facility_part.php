...
<section class="section">
    <div class="row">
        ...
        <div style="height:400px;overflow-y:scroll;" class="col-md-4">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><input class="tourism" onchange="facilityMapAll()" type="checkbox" value="F-<?php echo $facility[$i]->id_facility; ?>"> &nbsp &nbsp <?php echo $facility[$i]->name; ?></td>
            ...
            <div style="background-color: white;" id="panelRender">
                <input type="hidden" id="hiddenID" value="<?php echo $search; ?>"></input>
    ...
    <script>
        ...
        search_facility_part();

        function search_facility_part() {

            let id_get = $("#hiddenID").val();
            $.ajax({
                type: "GET",
                url: urlAplikasi + "web/search_facility_part_all/" + id_get,
                // data: 'keyword=' + $(this).val(),
                beforeSend: function() {
                    // $("#search-box").css("background", "#FFF url(LoaderIcon.gif) no-repeat 165px");
                },
