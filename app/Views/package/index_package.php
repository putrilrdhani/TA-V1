                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td style="word-break: break-all;"><?= $data[$i]->date ?></td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 80px;">
                                            <span class="float-right">
                                                ...
                                                <a class="deleteStyle" href="<?= base_url('package_day/delete/' . $package_day['features'][$i]['properties']['id_package'] . "/" . $package_day['features'][$i]['properties']['day']) ?>" onclick="javascript: return confirm('Delete \nAre You Sure ?')"><i style="color:red" class="fa fa-trash" aria-hidden="true"></i></a>
                                            </span>
                                        </td>
                                    </tr>
                                <?php
        ...
        <div class="card">
            <div class="card-header">
                <div class="row align-items-center">
                    ...
                    <div class="row">
                        <div class="d-flex p-2 bd-highlight">
                            <a href="<?= base_url('service_package/create') ?>" class="btn btn-sm btn-primary">SERVICE PACKAGE</a>
                        </div>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 80px;">
                                            <span class="float-right">
                                                ...
                                                <a href="<?= base_url('service_package/delete/' . $service_package['features'][$i]['properties']['id_service_package']) ?>" onclick="javascript: return confirm('Delete \nAre You Sure ?')"><i style="color:red" class="fa fa-trash" aria-hidden="true"></i></a>
                                            </span>
                                        </td>
                                    </tr>
                                <?php
        ...
        <div class="card">
            <div class="card-header">
                <div class="row align-items-center">
                    ...
                    <div class="row">
                        <div class="d-flex p-2 bd-highlight">
                            <a href="<?= base_url('detail_package/create') ?>" class="btn btn-sm btn-primary">DETAIL PACKAGE</a>
                        </div>
                    </div>
                    <div class="row">
                        <table class="showDataTable" class="table table-hover">
                            ...
                            <tbody>
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $detail_package['features'][$i]['properties']['activity_type'] ?></td>
                                        <td><?= $detail_package['features'][$i]['properties']['id_object'] ?></td>
                                        <td><?= $detail_package['features'][$i]['properties']['description'] ?></td>
                                        <td style="width: 80px;">
                                            <span class="float-right">
                                                <a href="<?= base_url('detail_package/read/' . $detail_package['features'][$i]['properties']['id_package'] . "/" . $detail_package['features'][$i]['properties']['day'] . "/" . $detail_package['features'][$i]['properties']['activity']) ?>"><i class="fa-solid fa-bars"></i></a>
                                                ...
                                                <a href="<?= base_url('detail_package/delete/' . $detail_package['features'][$i]['properties']['id_package'] . "/" . $detail_package['features'][$i]['properties']['day'] . "/" . $detail_package['features'][$i]['properties']['activity']) ?>" onclick="javascript: return confirm('Delete \nAre You Sure ?')"><i style="color:red" class="fa fa-trash" aria-hidden="true"></i></a>
                                            </span>
                                        </td>
                                    </tr>
                                <?php
