        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <select id="tourism_facility_select" class="form-control">
                        <?php
                    ...
                    <br />
                    <button onclick="saveTourismFacility('<?= $data[0]->id_true ?>')" class="btn btn-warning">Save</button>
                </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <form action="<?= base_url($action) ?>" method="post" enctype="multipart/form-data">
                            ...
                            ?>
                                ...
                                <input id="id" class="form-control" type="hidden" style="display:none;" name="id" value="<?= $data[0]->id_true ?>">
                            <?php
                            } else {
                            ?>
                                <div class="form-group">
                                                ...
                                                ?>
                                                    ...
                                                    <td style="width: 80px;">
                                                        <span class="float-right">
                                                            ...
                                                            <a onclick="deleteTourismFacility('<?= $dataFacility[$i]['id']; ?>','<?= $dataFacility[$i]['id_facility']; ?>')"><i style="color:red" class="fa fa-trash" aria-hidden="true"></i></a>
                                                        </span>
                                                    </td>
                            ...
                            <div class="d-flex p-2 bd-highlight">
                                <div class="form-group">
                                    <a class="btn btn-sm btn-danger" href="<?= base_url('tourism_object') ?>">Cancel</a>
