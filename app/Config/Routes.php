...
// $routes->get('/detail_package/delete/(:any)', 'Detail_package::delete/$1', ['filter' => 'role:administrator']);
$routes->get('/detail_package/update/(:any)/(:any)', 'Detail_package::update/$1/$2', ['filter' => 'role:administrator']);
